...
class Trie:
    ...
    def startsWith(self, prefix: str) -> bool:
        """
        We start from the root node and traverse the trie until we reach the end of the prefix.
        In this case, we don't need to check if the last node is a #, because we are not
        looking for a complete word.
